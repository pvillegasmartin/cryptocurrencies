...
def create_data(file='C:/Users/Pablo/Desktop/PMG/00Versions/get_data/BTCUSDT-4h.csv', period='4H', output=10,
                periods_out=6, kind='+', past_candles=15, training=True):
...
if __name__ == '__main__':
    ...
    past_candles = 20
    if not training:
        filename = f'Skl HistGBM_profit+10.sav'
    # ----------------------------

    fee = 0.04
    x_train, y_train, x_test, y_test, x_original, y_original, scaler = create_data(
        file='C:/Users/Pablo/Desktop/PMG/00Versions/get_data/ADAUSDT-4h.csv',
    ...
    if training:
        ...
        x_original['Final_close'] = (x_original['Close'].shift(-periods_out) - x_original['Close']) / x_original['Close']
